...
public class CasoPractico1 {
	...
	//Crear entrenadores y asignar su Pokemon
	...
	mostrarDatosEntrenadores(entrenador1, entrenador2);
	simularCombate(entrenador1, entrenador2);
	
	}

		private static void mostrarDatosEntrenadores(Entrenador entrenador1, Entrenador entrenador2) {
		//Mostrar datos de entrenadores y sus Pokemon
		System.out.println("====DATOS DE ENTRENADORES====");
		System.out.println(entrenador1);
		System.out.println("Pokemon de " + entrenador1.getNombre() + " : " + entrenador1.getCompanero());
		System.out.println();
		System.out.println(entrenador2);
		System.out.println("Pokemon de " + entrenador2.getNombre() + " : " + entrenador2.getCompanero());
	}
	
	private static void simularCombate(Entrenador entrenador1, Entrenador entrenador2) {
		System.out.println("\n=== COMBATE ===");
		
		//Organizar el combate entre los Pokemon principales
		Combate combate = new Combate(entrenador1.getCompanero(), entrenador2.getCompanero());
